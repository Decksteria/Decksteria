...
public interface IDecksteriaFileReader
{
    ...
    public string BuildConnectionString(string fileName, IDictionary<string, string> connectionProperties, string downloadURL, CancellationToken cancellationToken = default);
    ...
    public Task<string> GetFileLocationAsync(string fileName, string downloadURL, CancellationToken cancellationToken = default);
    ...
    public Task<byte[]> ReadByteFileAsync(string fileName, string downloadURL, CancellationToken cancellationToken = default);
    ...
    public Task<string> ReadTextFileAsync(string fileName, string downloadURL, CancellationToken cancellationToken = default);
}
